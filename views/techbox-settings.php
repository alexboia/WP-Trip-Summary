<script type="text/javascript">
    ...
    var abp01_saveAction = '<?php echo $data->ajaxSaveAction; ?>';
</script>
<div id="abp01-settings-container">
    <h2><?php echo __('General Settings', 'abp01-trip-summary'); ?></h2>
    ...
    <h2><?php echo __('Viewer settings', 'abp01-trip-summary'); ?></h2>
    <div class="abp01-settings-info description">
    ...
    <h2><?php echo __('Map Settings', 'abp01-trip-summary'); ?></h2>
    <div class="abp01-settings-info description">
    ...
    <div class="apb01-settings-save">
        <input id="abp01-submit-settings" name="abp01-submit-settings" class="button button-primary abp01-form-submit-btn" value="<?php echo __('Save settings', 'abp01-trip-summary'); ?>" />
    </div>
</div>
